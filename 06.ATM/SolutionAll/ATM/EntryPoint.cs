...
namespace ATM
{
    class EntryPoint
    {
        ...
        static void Validation(Customers[] customer, string cardNumberInput, int pinConverted, int convertedOperation)
        {
        ...
        static void BalanceChecking(Customers[] customer, string creditCard)
        {
        ...
        static void CashWithdrawal(Customers[] customer, string cardNumberInput)
        {
        ...
        static void CashDeposition(Customers[] customer, string cardNumberInput)
        {
